...
如果用户执行 `/cognitive-kernel check --full`，额外检查：
- 回复中是否有"应该可以"/"should work" 等模糊措辞 → 提示违反 L3 #3
- 回复中声称完成但无验证证据 → 提示违反 L3 #1
- 回复陈述事实但未标注来源 → 提示违反 L3 #4
